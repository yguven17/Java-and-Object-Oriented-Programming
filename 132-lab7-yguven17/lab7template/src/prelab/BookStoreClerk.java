...
public class BookStoreClerk {
	...
	private String[] partitionString(String input) throws IllegalArgumentException, NumberFormatException {
	...
	public Book readAndValidateBook() throws IllegalArgumentException, NumberFormatException {
